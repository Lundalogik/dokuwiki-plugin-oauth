...
$lang['azure-tenant'] = 'The Azure tenant ID or "common" to use the common tenant.';
$lang['azure-key'] = 'The application ID assigned to your app.';
$lang['azure-secret'] = 'The client secret of your application.';
$lang['azure-groupmapping'] = 'Map of Azure group object IDs to DokuWiki groups. One mapping per row. GUID = Dokuwiki group name.';
...
$lang['autoLoginRedirect'] = 'Automatically redirect to provider login page if not authenticated. Only possible when the singleService option is enabled.';
$lang['logoutRedirect'] = 'URL to redirect to when logging out.';
